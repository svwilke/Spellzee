...
public class ItemSlotServerHandler : EncounterServerHandler {

	private Pawn[] pawns;
	private int level;

	public ItemSlotServerHandler(Game game, Encounter encounter, Pawn[] pawns, int level) : base(game, encounter) {
		this.pawns = pawns;
		this.level = level;
