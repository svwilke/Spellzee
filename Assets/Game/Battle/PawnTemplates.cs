...
public class PawnTemplates {
	...
	public static PawnTemplate Cutpurse = Register("cutpurse", new PawnTemplate("Cutpurse").SetMaxHp(8).ZeroAffinites().SetAffinity(Element.Physical, 10).SetAffinity(Element.None, 10).AddSpells(Spells.Slice));
	public static PawnTemplate Golem = Register("golem", new PawnTemplate("Golem").SetMaxHp(10).ZeroAffinites().SetAffinity(Element.Physical, 10).SetAffinity(Element.None, 10).AddSpells(Spells.Stomp));
