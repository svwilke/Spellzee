namespace RetroBlitDemoSuperFlagRun
{
    ...
    public class SceneGame : Scene
    {
        ...
        public override bool Initialize()
        {
            ...
            mPlayerOne = new EntityPlayer(new Vector2(RB.SpriteSize().width * 2, 420), RB.PLAYER_ONE);
            mPlayerTwo = new EntityPlayer(new Vector2(((LEVEL_WIDTH - 1) * RB.SpriteSize().width) - (RB.SpriteSize().width * 2), 420), RB.PLAYER_TWO);

            mFlagOne = new EntityFlag(new Vector2(RB.SpriteSize().width, (RB.SpriteSize().height * 25) + 5), RB.PLAYER_ONE);
            mFlagTwo = new EntityFlag(new Vector2(((LEVEL_WIDTH - 2) * RB.SpriteSize().width) - 8, (RB.SpriteSize().height * 25) + 5), RB.PLAYER_TWO);

            mFlagOneSlot = new EntityFlagSlot(new Vector2((RB.SpriteSize().width * 3) - 8, (RB.SpriteSize().height * 25) + 5), RB.PLAYER_ONE);
            mFlagTwoSlot = new EntityFlagSlot(new Vector2((LEVEL_WIDTH - 4) * RB.SpriteSize().width, (RB.SpriteSize().height * 25) + 5), RB.PLAYER_TWO);
