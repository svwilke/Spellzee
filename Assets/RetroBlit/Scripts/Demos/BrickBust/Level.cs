namespace RetroBlitDemoBrickBust
{
    ...
    public class GameLevel
    {
        ...
        public GameLevel(int levelIndex)
        {
            ...
            // Top wall
            AddWall(new Wall(new Rect2i(-100, -100, RB.DisplaySize.width + 200, 100 + ((RB.SpriteSize(0).height * 3) - 4))));

            // Left wall
            AddWall(new Wall(new Rect2i(-100, 0, 100 + (RB.SpriteSize(0).width - 4), RB.DisplaySize.height + 100)));

            // Right wall
            AddWall(new Wall(new Rect2i(RB.DisplaySize.width - (RB.SpriteSize(0).width - 4), 0, 100, RB.DisplaySize.height + 100)));
        ...
        public void Render()
        {
            ...
            for (int renderPass = 0; renderPass < 2; renderPass++)
            {
                if (renderPass == 0)
                {
                    ...
                    RB.ShaderColorSet(C.SHADER_SHADOW, "_ShadowColor", new Color32(0, 0, 0, 96));
