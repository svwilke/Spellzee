    ...
    public class MainMenu
    {
        ...
        private class Blob
        {
            ...
            public Blob()
            {
                ...
                {
                    case 0:
                        mColorTint = C.COLOR_GOLD_BRICK;
                        break;

                    case 1:
                        mColorTint = C.COLOR_BLUE_BRICK;
                        break;

                    case 2:
                        mColorTint = C.COLOR_GREEN_BRICK;
                        break;

                    case 3:
                        mColorTint = C.COLOR_BROWN_BRICK;
                        break;

                    case 4:
                        mColorTint = C.COLOR_PINK_BRICK;
                        break;

                    case 5:
                        mColorTint = C.COLOR_BLACK_BRICK;
                        break;
                }
            }
