namespace RetroBlitDemoBrickBust
{
    ...
    public class LaserShot : Collidable
    {
        ...
        {
            RB.SoundPlay(C.SOUND_LASERHIT, 1, UnityEngine.Random.Range(0.9f, 1.1f));
        }
        ...
        private void CheckCollision(Collidable collidable)
        {
            ...
            if (collidable.Rect.Intersects(Rect))
            {
                ...
                game.Level.Particles.Impact(new Vector2i(Rect.x + 3, Rect.y + 5), new Vector2(0, -1), C.COLOR_GREEN_BRICK);
                Dead = true;
            }
        }
    }
