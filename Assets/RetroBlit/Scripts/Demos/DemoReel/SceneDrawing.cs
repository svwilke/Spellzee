namespace RetroBlitDemoReel
{
    ...
    public class SceneDrawing : SceneDemo
    {
        ...
        public override void Enter()
        {
            ...
            RB.FontSetup(0, 'A', 'Z', new Vector2i(0, 16), 0, new Vector2i(12, 12), 10, 1, 2, false);
        }
        ...
        private void DrawRotate(int x, int y, int spriteIndex)
        {
            ...
            mFormatStr.Append("@MRB@N.DrawSprite(@Knew @MVector2i(@1@N, @L1@N), @Knew @MVector2i@N(@L8@N, @L8@N), @L").Append((RB.Ticks * 4) % 360).Append("@N);");
        ...
        private void DrawCustomFont(int x, int y)
        {
            ...
            RB.Print(0, new Vector2i(0, 0), Color.white, mFormatStr);

            RB.CameraReset();

            mFormatStr.Set("@C// Print text with custom font from sprite sheet\n");
            mFormatStr.Append("@MRB@N.FontSetup(@L0@N, @S'A'@N, @S'Z'@N, @Knew @MVector2i@N(@L0@N, @L16@N), @L0@N,\n");
            mFormatStr.Append("    @Knew @MVector2i@N(@L12@N, @L12@N), @L10@N, @L1@N, @L2@N, @Kfalse@N, @Ktrue@N);\n");
            mFormatStr.Append("@MRB@N.Print(@Knew @MVector2i@N(@L0@N, @L0@N), @I01,\n");
