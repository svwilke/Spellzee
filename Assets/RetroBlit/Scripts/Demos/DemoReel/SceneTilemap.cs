namespace RetroBlitDemoReel
{
    ...
    public class SceneTilemap : SceneDemo
    {
        ...
        private void DrawSetTile(int x, int y)
        {
            ...
            mFormatStr.Append("@MRB@N.DrawMap(@L0@N);\n");
        ...
        private void DrawTMX(int x, int y)
        {
            ...
            mFormatStr.Append("@Kvar@N map = @MRB@N.MapLoadTMX(@S\"Demos/Demo/Tilemap.xml\"@N);\n");
            mFormatStr.Append("@MRB@N.MapLoadTMXLayer(map, @S\"Clouds\"@N, @L1@N);\n");
            mFormatStr.Append("@MRB@N.MapLoadTMXLayer(map, @S\"Decoration\"@N, @L2@N);\n");
            mFormatStr.Append("@MRB@N.MapLoadTMXLayer(map, @S\"Terrain\"@N, @L3@N);\n");
            ...
            mFormatStr.Append("@Kint@N pos = @L").Append(-(int)RB.Ticks).Append("@N % (map.size.width * @MRB@N.SpriteSize.width);\n");
            mFormatStr.Append("@MRB@N.DrawMapLayer(@L1@N, @Knew @MVector2i@N(pos, @L0@N));\n");
            mFormatStr.Append("@MRB@N.DrawMapLayer(@L1@N, @Knew @MVector2i@N(pos + (map.size.width * @MRB@N.SpriteSize.width)), @L0@N));\n");
