namespace RetroBlitDemoReel
{
    ...
    public class SceneGameLoop : SceneDemo
    {
        ...
        private string mMarkedUpCode =
            ...
            "      @C// RetroBlit will call this method at startup after calling\n" +
            "      @C// QueryHardware.\n" +
            "      @MRB@N.SpriteSheetSetup(@L0@N, @S\"HelloWorld/Sprites\"@N, @Knew @MVector2i@N(@L8@N, @L8@N));\n" +
            "      @MRB@N.SpriteSheetSet(@L0@N);\n" +
            "\n" +
            "      @Kreturn true@N;\n" +
            "   }\n" +
            "\n" +
