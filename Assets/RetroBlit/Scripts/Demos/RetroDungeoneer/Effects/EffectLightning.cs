namespace RetroBlitDemoRetroDungeoneer
{
    ...
    public class EffectLightning : Effect
    {
        ...
        public override void Render()
        {
            ...
            var sourcePos = new Vector2i(source.pos.x * RB.SpriteSize(0).width, source.pos.y * RB.SpriteSize(0).height);
            sourcePos += new Vector2i(RB.SpriteSize(0).width / 2, RB.SpriteSize(0).height / 2);

            var targetPos = new Vector2i(target.pos.x * RB.SpriteSize(0).width, target.pos.y * RB.SpriteSize(0).height);
            targetPos += new Vector2i(RB.SpriteSize(0).width / 2, RB.SpriteSize(0).height / 2);
