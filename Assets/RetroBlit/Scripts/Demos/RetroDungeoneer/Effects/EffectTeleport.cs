namespace RetroBlitDemoRetroDungeoneer
{
    ...
    public class EffectTeleport : Effect
    {
        ...
        public EffectTeleport(Vector2i srcPos, Vector2i destPos) : base(EffectType.Teleport)
        {
            ...
            mSrcPos = new Vector2(srcPos.x * RB.SpriteSize(0).width, srcPos.y * RB.SpriteSize(0).height);
            mDestPos = new Vector2(destPos.x * RB.SpriteSize(0).width, destPos.y * RB.SpriteSize(0).height);
            ...
            SoundBank.Instance.SoundPlayDelayed(C.SOUND_TELEPORT, 1.0f, RandomUtils.RandomPitch(0.1f), Random.Range(0, 5));
        }
        ...
        private Particle NewParticle()
        {
            ...
            p.pos = new Vector2(
                    Random.Range(pos.x, pos.x + RB.SpriteSize(0).width + 1),
                    Random.Range(pos.y, pos.y + RB.SpriteSize(0).height + 1));
