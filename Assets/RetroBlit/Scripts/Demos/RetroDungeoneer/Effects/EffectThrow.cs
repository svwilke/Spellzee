namespace RetroBlitDemoRetroDungeoneer
{
    ...
    public class EffectThrow : Effect
    {
        ...
        private int mLaunchSound = -1;
        private int mLandSound = -1;
        ...
        public EffectThrow(EntityID source, EntityID target, Vector2i targetPos, PackedSpriteID projectileSprite, Color32 projecticleColor, int launchSound, int landSound) : base(EffectType.Throw)
        {
            mSourcePos = new Vector2i(source.e.pos.x * RB.SpriteSize(0).width, source.e.pos.y * RB.SpriteSize(0).height);
        ...
        /// <param name="launchSound">Launching sound</param>
        /// <param name="landSound">Landing sound</param>
        public EffectThrow(EntityID source, EntityID target, Vector2i targetPos, PackedSpriteID projectileSprite, PackedSpriteID projecticleSprite45, Color32 projecticleColor, int launchSound, int landSound) : base(EffectType.Throw)
        {
            mSourcePos = new Vector2i(source.e.pos.x * RB.SpriteSize(0).width, source.e.pos.y * RB.SpriteSize(0).height);
        ...
        public override void Render()
        {
            ...
            if (target != null)
            {
                targetPos = new Vector2i(target.pos.x * RB.SpriteSize(0).width, target.pos.y * RB.SpriteSize(0).height);
            }
            else
            {
                targetPos = new Vector2i(mTargetPos.x * RB.SpriteSize(0).width, mTargetPos.y * RB.SpriteSize(0).height);
            }
        ...
        public override void Write(BinaryWriter writer)
        {
            ...
            writer.Write(mLaunchSound);
            writer.Write(mLandSound);
        }
        ...
        public override void Read(BinaryReader reader)
        {
            ...
            mLaunchSound = reader.ReadInt32();
            mLandSound = reader.ReadInt32();
        }
    }
}
