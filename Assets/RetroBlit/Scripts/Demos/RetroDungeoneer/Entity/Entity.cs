        ...
        public Vector2i pos
        {
            ...
            set
            {
                ...
                if (moveTrail != null && oldPos.x != -1 && oldPos.y != -1)
                {
                    ...
                    Vector2 startPos = new Vector2(oldPos.x * RB.SpriteSize(0).width, oldPos.y * RB.SpriteSize(0).height);
                    Vector2 endPos = new Vector2(mPos.x * RB.SpriteSize(0).width, mPos.y * RB.SpriteSize(0).height);
                    ...
                    if (game.map.IsInFOV(oldPos) || game.map.IsInFOV(mPos))
                    {
                        ...
                        int spacing = (int)(RB.SpriteSize(0).width / 2.5f);
