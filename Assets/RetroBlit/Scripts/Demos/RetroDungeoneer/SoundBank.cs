namespace RetroBlitDemoRetroDungeoneer
{
    ...
    public class SoundBank
    {
        ...
        /// </summary>
        /// <param name="soundSlot">Sound to play</param>
        /// <param name="volume">Volume</param>
        /// <param name="pitch">Pitch</param>
        /// <param name="framesUntilPlay">Frames until sound plays</param>
        public void SoundPlayDelayed(int soundSlot, float volume, float pitch, int framesUntilPlay)
        {
            PendingSound pendingSound = new PendingSound();
            pendingSound.soundSlot = soundSlot;
